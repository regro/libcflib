...
class CachedData:
    ...
    FILE_LISTING_URL = 'https://raw.githubusercontent.com/regro/libcfgraph/master/.file_listing.json'
    HUBS_AUTHS_URL = 'https://raw.githubusercontent.com/regro/cf-graph-countyfair/master/ranked_hubs_authorities.json'
    DEFAULT_SESSION_SETTINGS = {
        'cache_name': str(pathlib.Path('~/.config/libcflib/cache_session.sqlite').absolute()),
        'backend': 'sqlite',
        'exire_after': 60*60*1
    }
