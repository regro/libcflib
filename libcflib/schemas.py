SCHEMAS = {
    "artifact": {
        ...
        "type": "dict",
        "schema": {
            "name": {"_description": "Name of the package", "type": "string"},
            "rendered": {
            ...
            "files": {"_description": "Files written by conda-build", "type": "set"},
            "version": {
                "_description": "Version of the code for this node, "
                'notethat "latest" is the latest '
                "version",
                "type": "string",
            },
            "about": {"_description": "metadata about the package", "type": "dict"},
            "index": {"_description": "Core file, name verson " "deps", "type": "dict"},
        },
    },
    "package": {
        ...
        "schema": {
            ...
            "artifacts": {"_description": "Links to the artifacts", "type": "list"},
